"""
Django settings for tstjuancacheprdre_1 project.
...
ROOT_URLCONF = 'tstjuancacheprdre_1.urls'
...
WSGI_APPLICATION = 'tstjuancacheprdre_1.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "TSTJuanCachePRDRe Support <support@tstjuancacheprdre-1.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tstjuancacheprdre_1 API",
    "DESCRIPTION": "API documentation for tstjuancacheprdre_1 App",
    "VERSION": "v1",
}
